...
public partial class MessageManager : CanvasLayer
{
    ...
    public static void PlayText(params string[] payload)
    {
        ...
        Signals.EmitGlobalSignals(Signals.SignalName.MessageBoxOpen, true);
    ...
    public static async void ScrollText()
    {
        ...
        if (Instance.Messages.Count == 0)
        {
            ...
            Signals.EmitGlobalSignals(Signals.SignalName.MessageBoxOpen, false);
            return;
        }
    ...
    public static Array<string> GetMassseges()
    {
